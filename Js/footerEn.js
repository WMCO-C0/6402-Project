          ...
          <div class="row LineaFoot">
            ...
            <div class="col-12 col-md-4 mt-5 d-flex flex-column align-items-center justify-content-center">
              <div class="d-flex flex-column align-items-center justify-content-center text-center footer-license">
                <p class="lic-title" style="margin-bottom: .25rem;"><strong>License:</strong> Attribution-NonCommercial-NoDerivatives (CC BY-NC-ND 4.0)</p>
                <p class="lic-desc" style="margin-bottom:.75rem;">Some images and materials on this site are available under the Creative Commons Attribution-NonCommercial-NoDerivatives license. This allows sharing the material with attribution but does not permit commercial use or derivative works. For more information, visit <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/" target="_blank" rel="noopener noreferrer" style="color: #F1E8D9; text-decoration: underline;">CC BY-NC-ND 4.0</a>.</p>
                <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/" target="_blank" rel="noopener noreferrer" aria-label="CC BY-NC-ND license" style="display:inline-block;">
